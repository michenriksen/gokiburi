...
export declare function createDataTableStore<T extends Record<PropertyKey, any>>(
	source: T[],
	options?: DataTableOptions<T>
): {
	subscribe: (
		this: void,
		run: import('svelte/store').Subscriber<DataTableModel<T>>,
		invalidate?: ((value?: DataTableModel<T> | undefined) => void) | undefined
